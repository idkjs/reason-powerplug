...
function Main(Props) {
  return React.createElement(
    "div",
    undefined,
    React.createElement("h1", undefined, "Input Functor"),
    React.createElement(Input$ReasonPowerplug.make, {
      children: function (param) {
        ...
        return React.createElement(
          ...
          React.createElement(
            "p",
            undefined,
            "open the console to see changes",
          ),
    ...
    React.createElement("h1", undefined, "Value Functor"),
    React.createElement(Value.make, {
      ...
      children: function (param) {
        ...
        return React.createElement(
          ...
          React.createElement(Interval$ReasonPowerplug.make, {
            delay: param.value,
            children: function (param) {
              var stop = param.stop;
    ...
    React.createElement("h1", undefined, "Hover Functor"),
    React.createElement(Hover$ReasonPowerplug.make, {
      children: function (param) {
        return React.createElement(
          ...
          " You are " +
            ((param.hovered ? "hovering" : "not hovering") + "this div"),
        );
      },
    }),
    React.createElement("h1", undefined, "StringSet"),
    ...
    React.createElement("h1", undefined, "Number"),
    ...
    React.createElement("h1", undefined, "Counter"),
    ...
    React.createElement("h1", undefined, "Toggle"),
    React.createElement(Toggle$ReasonPowerplug.make, {
      initial: true,
      onChange: function (param) {
        return Utils$ReasonPowerplug.$less$pipe$pipe(
          function (prim) {
            console.log(prim);
          },
      ...
      children: function (param) {
        ...
        return React.createElement(
          ...
          React.createElement(
            "div",
            undefined,
            param.on ? "toggle show" : null,
          ),
        );
      },
    }),
    React.createElement("h1", undefined, "StringList"),
